...
<ul>
  ...
  <li><b>Scripts/MainMenuScript.cs</b> - Where all Main Menu UI design button alignment all resides.</li>
  <li><b>Scripts/ScoreScript.cs</b> - This Maintains the Score Increment With Every non mine block is opened.</li>
  <li><b>Scripts/DifficultyScript.cs</b> - This Maintains all 3 difficulty level which change in number of mines and also reduces completion time.</li>
  ...
  <li><b>Scripts/TimerScript.cs</b> - This Keep Track of reverse timing of game once time reach to 0 seconds it declare game over.</li>
...
![-----------------------------------------------------](https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/rainbow.png)
 ...
 <ul>
  <li><b>STEP-1 </b> - To Download Source Code and Playable Build click <a href="https://github.com/Sagargupta16/Minesweeper-Game__UnityEngine/releases/latest">Download</a>.</li>
  <li><b>STEP-2 </b> - Extract the <b>MinsweeperBuild.zip</b> for Playable Content and the <b>Source code (zip)</b> to see Source Code Content.</li>
  <li><b>STEP-3 </b> - Open Extracted Folder Then double Click on <b>Minesweeper.exe</b> to play game.</li>
